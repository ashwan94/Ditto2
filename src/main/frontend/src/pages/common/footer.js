                    ...
                    <div className="tc uf ap gg fp">
                        ...
                        <div className="vd ro tc sf rn un gg vn">
                            <div className="animate_top">
                                ...
                                <ul>
                                    <li><a href="http://nextit.or.kr:23124/" className="sc xl vb">홈</a></li>
                                    <li><a href="http://nextit.or.kr:23124/book/list" className="sc xl vb">도서</a></li>
                                    <li><a href="http://nextit.or.kr:23124/membershipInfo" className="sc xl vb">멤버십</a></li>
                                </ul>
                            </div>
                            <div className="animate_top">
                                <h4 className="kk wm tj ec rundry">시설 안내</h4>
                                <ul>
                                    <li><a href="http://nextit.or.kr:23124/seat/list" className="sc xl vb">열람실</a></li>
                                    <li><a href="http://nextit.or.kr:23124/seat/list" className="sc xl vb">내부 구조도</a></li>
                                </ul>
                            </div>
                            <div className="animate_top">
