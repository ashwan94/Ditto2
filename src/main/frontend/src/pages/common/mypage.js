...
export default function Mypage() {
    ...
    const saveMemberData = async () => {
        ...
        if(memberView.memberNickname == memberNickname && memberView.memberPostcode == memberPostcode && memberView.memberAdd == memberAdd
            && memberView.memberDetailAdd == memberDetailAdd && memberView.memberBirth == memberBirth){
            return;
        }
        const memberData = {
            memberId: memberView.memberId, // 로그인 회원 아이디
                                ...
                                <div className="media-body va-m" style={{flex: "none"}}>
                                    <ul className="media-heading text-center rundry text-xl" style={{color: "black"}}>
                                        <li style={{
                                            ...
                                            {memberView.memberNickname}님 환영합니다
                                        </li>
