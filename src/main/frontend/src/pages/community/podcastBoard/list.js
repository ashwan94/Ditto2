            ...
            <div className="text-black">
                ...
                <span className="right">
                    <select onChange={searchTypeOnChangeHandler}>
                        <option value="방송 제목">방송 제목</option>
                ...
                <table>
                    ...
                    <tr className="text-center">
                        ...
                        <th className="large-col">방송 제목</th>
                        <th className="small-col">호스트</th>
                        ...
                        <tr key={i} className="text-center">
                            ...
                            <td className="left large-col">
                                <Link
                                    to={`/community/${boardType}/chat`}
                                    state={board.podcastBoardNo}>
                                    <span>{board.podcastTitle}&nbsp;&nbsp;
                                        {board.onair === 'LIVE' ? <img src="/images/onair.png" className="w-10 inline"/> : null}
                                    </span>
                                </Link>
                            </td>
